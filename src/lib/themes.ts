...
//
// The five "official" lab themes (energy-systems, land-use, trade, impacts,
// solutions) get curated palette assignments — these are the themes with
// dedicated /research/<slug> pages. Any other theme slug that appears in the
...
const DYNAMIC_PALETTE_INDICES = [1, 4, 8, 7]
